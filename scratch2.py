...
model = get_model("resnet18", "mixvpr", pretrained=False, descriptor_size=2048)

qmodel = quantize_model_trt(model, precision="int8", descriptor_size=2048, model_name="my_model_test", force_recalibration=False)
print("======================================", type(qmodel))
for _ in range(100):
    out = qmodel(img)
    print(out.shape)
