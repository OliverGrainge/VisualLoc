...
parser.add_argument('--methods', choices=("mixvpr", "convap", "amosnet", "hybridnet", "netvlad", "hog", "cosplace", "calc", "alexnet"),
...
parser.add_argument('--num_workers', type=int, default=16, help="Choose the number of processing the threads for the dataloader")
...
if args.mode == "describe":
    for method_name in args.methods:
        ...
        for dataset_name in args.datasets:
            ...
            del map_loader 
            query_loader = ds.query_images_loader(partition=args.partition, preprocess=method.preprocess, num_workers=args.num_workers)
