...
class GsvBase:
    def __init__(self, root="/home/oliver/Documents/github/Datasets/gsv_cities/",
                 cities: list=["London"], min_img_per_place: int=4):
        self.root = root
        self.cities = cities
...
class GsvCities(BaseDataset, GsvBase):
    ...
    def __init__(self, root: str="/home/oliver/Documents/github/Datasets/gsv_cities/", cities: list=["London", "Boston"], min_img_per_place: int=4):
    ...
    def query_partition(self, partition: str) -> np.ndarray:
        ...
        elif partition == "val": paths = self.query_paths[int(size*0.8):int(size*0.9)]
        elif partition == "test": paths = self.query_paths[int(size*0.9):]
