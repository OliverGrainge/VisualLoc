...
def parse_arguments():
    ...
    parser.add_argument("--lambda_lat", type=float, default=1.0, help="_")
    parser.add_argument("--lambda_front", type=float, default=1.0, help="_")
    parser.add_argument(
        "--groups_num", type=int, default=0, help="If set to 0 use N*N groups"
    )
    ...
    # Training parameters
    parser.add_argument(
        "--batch_size", type=int, default=train_args.batch_size, help="_"
    )
