...
from PlaceRec.Training.models.backbones.dinov2.layers import Mlp, PatchEmbed, SwiGLUFFNFused, MemEffAttention, NestedTensorBlock as Block
...
class DinoVisionTransformer(nn.Module):
    ...
    def interpolate_pos_encoding(self, x, w, h):
        ...
        pos_encoding = torch.cat((class_pos_embed.unsqueeze(0), patch_pos_embed), dim=1)
