...
class VPRModel(pl.LightningModule):
    ...
    def __init__(
        ...
        aggregator = helper.get_aggregator(
            agg_arch, feature_map_shape, out_dim=self.descriptor_size
        )
...
if __name__ == "__main__":
    ...
    datamodule = GSVCitiesDataModule(
        ...
        val_set_names=[
            "pitts30k_val"
        ],  # pitts30k_val, pitts30k_test, msls_val, nordland, sped
    )
    ...
    earlystopping_cb = EarlyStopping(
        monitor="pitts30k_val/R1", min_delta=0.00, patience=5, verbose=True, mode="max"
    )
    # ------------------
