...
source_directory = "/Users/olivergrainge/Documents/github/VisualLoc/Checkpoints"
# Directory where ONNX models will be saved
destination_directory = (
    "/Users/olivergrainge/Documents/github/VisualLoc/Onnx_Checkpoints"
)
...
for model_file in os.listdir(source_directory):
    ...
    try:
        ...
        print(f"Could to export {model_file}")
